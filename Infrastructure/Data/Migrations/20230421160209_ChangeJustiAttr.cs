...
{
    public partial class ChangeJustiAttr : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HearingFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HearingFiles_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sections_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserSections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppUserSections_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppUserSections_Sections_SectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_JustiFiles_Groups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "AppUserSections",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserSections_SectionId",
                table: "AppUserSections",
                column: "SectionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HearingFiles_AppUserId",
                table: "HearingFiles",
                column: "AppUserId");
