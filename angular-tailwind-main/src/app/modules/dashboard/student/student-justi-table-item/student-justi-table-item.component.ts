...
@Component({
  selector: '[student-justi-table-item]',
  templateUrl: './student-justi-table-item.component.html',
  styleUrls: ['./student-justi-table-item.component.scss'],
})
export class StudentJustiTableItemComponent implements OnInit {
  form: FormGroup;
  @Input() student = <any>{};
  isOpen = false;
  fileId: any;
